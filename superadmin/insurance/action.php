        ...
        if($type == 'insurance' || $type == 'vendor'){
            ...
            if($command == 'create' && $id == 'insurance'){
                ...
                && isset($_POST['description']) && !empty($_POST['description'])
                    ...
                    $sql = "INSERT INTO `".$id."`(`vendor_id`,`category`,`type`,`tenure`,`value`,`title`,`tags`,`price`,`description`,`views`,`status`,`date`) VALUES('$vendor','$category','$product_type','$tenure','$value','$title','$tags','$price','$description','0','0',NOW())";
                    $data = '{}';
                }else{

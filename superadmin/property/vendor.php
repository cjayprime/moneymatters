<?php
  ...
  $sql = "SELECT * FROM `vendor` WHERE `type` = 'property' AND `status` != '-1'";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'property','subpage'=>'vendor');
    ...
    <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Manage property vendors</h2>
          <p class="mg-b-0">View, delete and modify the account status of any property vendor.</p>
        </div>

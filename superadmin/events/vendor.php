<?php
  ...
  $sql = "SELECT * FROM `vendor` WHERE `type` = 'event' AND `status` != '-1'";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'events','subpage'=>'vendor');
    ...
    <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Manage event vendors</h2>
          <p class="mg-b-0">View, delete and modify the account status of any event vendor.</p>
        </div>
      ...
      $(function(){
        ...
        $(document).ready(function() {
            ...
            $('.deleterow').click(function(){
              $('#deletenow').attr('data-id',$(this).data('id'));
            });

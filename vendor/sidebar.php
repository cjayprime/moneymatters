...
$menu = array(
    ...
    'Finance' => array('Manage products' => 'list.php','Manage inquiries' => 'inquiry.php','Add new products' => 'add.php'),
    'Insurance' => array('Manage products' => 'list.php','Manage purchases' => 'purchase.php','Add new products' => 'add.php'),
    'Wedding' => array('Manage weddings' => 'list.php','Manage bookings' => 'booking.php','Add new wedding' => 'add.php'),
    'Events' => array('Manage events' => 'list.php','Manage bookings' => 'booking.php','Add new events' => 'add.php'),
    'Offers' => array('Manage offers' => 'list.php','Manage bookings' => 'booking.php','Add new offer' => 'add.php'),
    'Property' => array('Manage properties' => 'list.php','Manage bookings' => 'booking.php','Add new properties' => 'add.php'));
    ...
    <div class="az-sidebar">
        <div class="az-sidebar-loggedin">
            ...
            <div class="media-body">
                <h7>Moneymatters Vendor</h7>
                <span>{$rows['business_name']}</span>
            </div><!-- media-body -->

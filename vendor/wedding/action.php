        ...
        if($type == 'wedding' || $type == 'vendor'){
            ...
            if($command == 'create' && $id == 'wedding'){
                ...
                && isset($_POST['address']) && !empty($_POST['address'])){
                    ...
                    $sql = "INSERT INTO `".$id."`(`vendor_id`,`category`,`pictures`,`title`,`description`,`time`,`country`,`state`,`city`,`district`,`full_address`,`messages`,`rating`,`views`,`status`,`date`) VALUES('$vendor_id','$category','$pictures','$title','$description','$time','$country','$state','$city','$district','$full_address','[]','[]','0','0',NOW())";
                    $data = '{}';
                }else{

        ...
        if($type == 'finance' || $type == 'vendor'){
            ...
            if($command == 'create' && $id == 'finance'){
                ...
                && isset($_POST['description']) && !empty($_POST['description'])
                    ...
                    $sql = "INSERT INTO `".$id."`(`vendor_id`,`type`,`tenure`,`value`,`title`,`tags`,`price`,`description`,`views`,`status`,`date`) VALUES('$vendor_id','$product_type','$tenure','$value','$title','$tags','$price','$description','0','0',NOW())";
                    $data = '{}';
                }else{

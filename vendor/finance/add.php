<?php
    ...
    $sql = "SELECT * FROM `admin` WHERE `page` = 'finance' AND `title` = 'moneymatters'";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'finance','subpage'=>'add');
    ...
    <div class="az-content az-content-dashboard-two">
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Add new product</h2>
          <p class="mg-b-0">Follow the steps in the wizard to add a new finance product.</p>
        </div>
            ...
            $('#wizard').steps({
                ...
                onFinishing: function(event, currentIndex){
                    ...
                    if(currentIndex === 1) {
                        ...
                        var validate = {tenure: tenure, value: value, title: title, tags: tags, price: price, description: description};

<?php
    ...
    if(isset($_POST['command']) && !empty($_POST['command']) ){
        ...
        if($type == 'insurance' || $type == 'vendor'){
            ...
            if($command == 'create' && $id == 'insurance'){
                
                if(isset($_POST['category']) && !empty($_POST['category'])
                && isset($_POST['product_type']) && !empty($_POST['product_type']) && json_decode($_POST['product_type'],true) !== null
                ...
                && isset($_POST['description']) && !empty($_POST['description'])
                    ...
                    $sql = "INSERT INTO `".$id."`(`vendor_id`,`category`,`type`,`tenure`,`value`,`title`,`tags`,`price`,`description`,`views`,`status`,`date`) VALUES('$vendor_id','$category','$product_type','$tenure','$value','$title','$tags','$price','$description','0','0',NOW())";
                    $data = '{}';
                }else{

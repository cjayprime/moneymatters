<?php
  ...
  $sql = "SELECT * FROM `booking` WHERE (`vendor_id` = '$vendor_id') AND `type` = 'insurance' ORDER BY `status`";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'insurance','subpage'=>'purchase');
    ...
    <div class="az-content az-content-dashboard-two">
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Manage insurance purchases</h2>
          <p class="mg-b-0">View and finalize any insurance provider purchases and it's receipt.</p>
        </div>
            ...
            <table id="eventList" class="table" style="width: 100%;">
              <thead>
                <tr role="row">
                  ...
                  <th rowspan="1" colspan="1" style="width: 12%;">Purchase ID</th>

<?php
  ...
  $sql = "SELECT * FROM `booking` WHERE (`vendor_id` = '$vendor_id') AND `type` = 'event' ORDER BY `status`";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'events','subpage'=>'booking');
    ...
    <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Manage event bookings</h2>
          <p class="mg-b-0">View and complete any event booking and it's receipt.</p>
        </div>

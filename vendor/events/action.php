        ...
        if($type == 'event' || $type == 'vendor'){
            ...
            if($command == 'create' && $id == 'event'){
                ...
                && isset($_POST['address']) && !empty($_POST['address'])){
                    ...
                    $sql = "INSERT INTO `".$id."`(`vendor_id`,`category`,`pictures`,`title`,`description`,`time`,`guests`,`price`,`duration`,`country`,`state`,`city`,`district`,`full_address`,`views`,`status`,`date`) VALUES('$vendor_id','$category','$pictures','$title','$description','$time','$guests','$price','$duration','$country','$state','$city','$district','$full_address','0','0',NOW())";
                    $data = '{}';
                }else{

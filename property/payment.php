...
<html lang="en">
  ...
  <body>
    ...
    <?php
      $options = array('page' => 'property', 'subpage' => 'payment');
            ...
            <div class="theme-payment-page-sections">
              ...
              <div class="theme-payment-page-sections-item">
                <div class="theme-payment-page-booking">
                  ...
                  <a class="btn _tt-uc btn-primary-inverse btn-lg btn-block" id="book-now" href="order.php" style="background:#ee4a35; box-shadow: 0 2px 30px rgba(255,76,0,0.39);">Reserve Now</a>
                </div>
              </div>
            </div>
          </div>

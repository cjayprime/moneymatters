          ...
          <div class="form-group">
            ...
            <?php
              ...
              if(isset($_GET['verify']) && !empty($_GET['verify'])){
                $verify = $_GET['verify'];
                echo 
                '<h2>Verify the code sent to your email and</h2>
                ...
                echo <<<EOT
                  ...
                  <label style="margin-top:20px">Repeat Password</label>
          ...
          if(email){
            ...
            $.ajax({url: 'action.php',data: data,
                ...
                success:function(res,status,xhr){
                    console.log(res);
                    if(res.success)
                    window.location = '../admin/reset.php?verify='+res.data['verification'];
                    else

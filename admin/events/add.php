<?php
    ...
    $sql = "SELECT * FROM `admin` WHERE `page` = 'event' AND `title` = 'moneymatters'";
...
<html lang="en">
  ...
  <body class="az-body az-body-sidebar">
    ...
    <?php
      $options = array('page' => 'events','subpage'=>'add');
        ...
        <div class="row row-sm mg-t-40">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input id="title" class="form-control" placeholder="Enter a title for the event" type="text" required>
                </div>
            </div><!-- col -->
        </div><!-- row -->
    </section>
    ...
    <section>
        ...
        <div class="row row-sm mg-t-40">
            <div class="col-md-12">
                ...
                <textarea id="description" class="form-control" rows="3" placeholder="Enter the event's description" type="text" required></textarea>
            </div><!-- col -->
        </div><!-- row -->
    </section>
        ...
        <div class="row row-sm mg-t-40">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="input-group">
                    ...
                    <input id="dateandtimepicker" class="form-control" placeholder="When is the event?" value="March 29, 2019 12:00" type="text" required>
                </div>
            </div><!-- col -->
            <div class="col-md-6 col-lg-4 mg-t-20 mg-md-t-0">
            ...
            <div class="col-md-6 col-lg-4 mg-t-20 mg-md-t-0">
                ...
                <div class="input-group mb-3">
                    <input id="duration" class="form-control" placeholder="How long is the event?" type="number" required>
                    <div class="input-group-append">
                ...
                onStepChanging: function (event, currentIndex, newIndex) {
                    if(currentIndex < newIndex) {
                        ...
                        if(currentIndex === 1) {
                            ...
                            var validate = {category: category, price: price, description: description, images: images};
                        ...
                        if(currentIndex === 2) {
                            ...
                            var validate = {dateandtime: dateandtime,guests: guests,duration: duration};
                            for(var key in validate){
                                var elem = validate[key];
                                
                                if(key == 'dateandtime')
                                elem = validate[key].parents('.input-group');
                                
                                if((key == 'dateandtime' && (new Date(validate[key].val())) != 'Invalid Date') 
                                || 
                                (key != 'dateandtime' && /^[0-9]+$/.test(validate[key].val()))){
                                    if(key != 'dateandtime')//It is changing the border-width wrongly 
                                    elem.css(success);
                                } else {
                                    elem.css(error);
                                    error_text.push(key);

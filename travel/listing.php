...
<html lang="en">
  <head>
    <title>Travel Mate - Flight payment 2</title>
    <meta charset="UTF-8"/>
          ...
          <div class="col-md-8 ">
            <div class="theme-payment-page-sections">
              <div class="theme-payment-page-sections-item">
                <div class="theme-search-results-item theme-payment-page-item-thumb">
                  <div class="row" data-gutter="20">
                    <div class="col-md-9 ">
                      <p class="theme-search-results-item-flight-payment-airline">You are flying Fly Emirates</p>
                      <h5 class="theme-search-results-item-title">London, LCW &nbsp;&rarr;&nbsp; New York, EWR</h5>
                                  ...
                                  <ul class="theme-search-results-item-flight-details-schedule-list">
                                    <li>
                                      ...
                                      <div class="theme-search-results-item-flight-details-schedule-time">
                                        ...
                                        <span class="theme-search-results-item-flight-details-schedule-time-separator">&mdash;</span>
                                        <span class="theme-search-results-item-flight-details-schedule-time-item">09:10
                                          <span>pm</span>
                                        </span>
                                      </div>
                                      <p class="theme-search-results-item-flight-details-schedule-fly-time">8h 20m</p>
                                      <div class="theme-search-results-item-flight-details-schedule-destination">
                                        <div class="theme-search-results-item-flight-details-schedule-destination-item">
                                          <p class="theme-search-results-item-flight-details-schedule-destination-title">
                                            <b>LCW</b>Gatwich
                                    ...
                                    <li>
                                      ...
                                      <p class="theme-search-results-item-flight-details-schedule-fly-time">10h 50m</p>
                                      <div class="theme-search-results-item-flight-details-schedule-destination">
                                        <div class="theme-search-results-item-flight-details-schedule-destination-item">
                                          <p class="theme-search-results-item-flight-details-schedule-destination-title">
                                            <b>BOS</b>Logan
                    ...
                    <div class="col-md-3 ">
                      <div class="theme-search-results-item-img-wrap">
                        <img class="theme-search-results-item-img _mob-h" src=".././img/192x88.png" alt="Image Alternative text" title="Image Title"/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="theme-payment-page-sections-item">
                ...
                <a class="theme-payment-page-sections-item-new-link" href="#AddNewTraveler" data-toggle="collapse" aria-expanded="false" aria-controls="AddNewTraveler">+ Add New Passenger</a>
                ...
                <div class="row">
                  <div class="col-md-6 ">
                    <div class="theme-payment-page-form-item form-group">
                      <i class="fa fa-angle-down"></i>
                      <select class="form-control">
                        <option>**** **** **** 1994 MasterCard</option>
                        <option>**** **** **** 9811 MasterCard</option>
                        <option>**** **** **** 9023 MasterCard</option>
                        <option>**** **** **** 5133 Visa</option>
                        <option>**** **** **** 5792 Visa</option>
                      </select>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Quisque maecenas ridiculus eros nascetur ultricies lorem sit nisl turpis eros laoreet conubia tincidunt placerat</p>
                <p>Amet eros platea inceptos nam tortor vel scelerisque habitasse et phasellus hendrerit elit sollicitudin ad</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
